...
### Ejercicio
1. Elabora el diagrama de organización de tu sitio web (puedes emplear 
[Canva](https://www.canva.com/es_ar/graficos/organigramas/), 
[Lucidchart](https://lucid.co/lucidchart), 
[Draw.io](https://app.diagrams.net/) o a mano y puedes tomarle una foto)
2. Sube la imagen al repositorio del proyecto
...
RECUERDA en el repositorio Proyecto2026-Apellido1-Apellido2 crear una carpeta con el nombre "Sketch" y subir una o varias fotos
...
### Ejemplo de promt para generar las imagenes
> "Crea un diseño visual en alta fidelidad de 
> una aplicación web de Dojans. Utiliza un estilo moderno, 
> paleta de colores en tonos grises, tarjetas con Auto Layout 
> y capas organizadas, exclusivamente como estructura 
> de interfaz gráfica en el lienzo."
