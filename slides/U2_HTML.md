...
[Ejercicio: Formulario](U4_HTML_avanzado.html#/57)
...
[Github Classroom 2025](https://classroom.github.com/a/AJOJ1SC2)
...
<select name="materias">
    ...
    <option value="labCompu2">Taller de Desarrollo Web</option>
</select>
````
<select name="materias">
    <option value="analisisMat">Análisis Matemático</option>
...
Suele configurarse los atributos:
`rows="5" cols="50"`
