...
* Libre
* Crea branches y hace merge rápido y fácil
...
## Quién lo creó?
Git fue creado por el ingeniero de software finlandés Linus Torvalds en abril de 2005. Lo desarrolló para el control de versiones del código fuente del núcleo de Linux

![Linus Torvals](images/herramientas/Linus-torvalds.webp)
...
4. Abrir el **Cmd** o **Consola** o **Símbolos del Sistema** y escribir
```javascript
   git --version
```
<small> Deberas ver un texto como **git version 2.53.0.windows.1** </small>
...
Si aún no lo tienes, create una cuenta en [gitHub](www.github.com) ...**Sign up** ...for Free
...
## Ejercicio: Creación de Cuenta en GitHub
Una vez creada tu cuenta, envia el nombre de  usuario al Profe completando la planilla.
...
Hay otras alternativas, como emplear softwares de VCS, o herramientas inlcuidas dentro del mismo IDE (WebStorm, Visual Studio Code, etc).
...
Los ejercicios que venimos realizando de **Github Básico I**, **Github Básico II** y **Github Branchs** son de práctica,
puedes ingresar al **Settings**, y eliminar los respositorios que creaste solo para practicar.
...
[Link Classroom 2026](https://classroom.github.com/a/06Rmc9s1)
...
### Recomendación
Una vez que hayas creado tu repositorio a partir del repositorio de clase, usa ⭐ para dejarlo en tus favoritos.

El repositorio pertenece a **Github Classroom** y NO a tu espacio personal de github, por lo que puede resultarte complicado encontrarlo.

----

Para el docente es más sencillo hacer seguimiento de los respositorios de sus estudiantes.

![Classroom](images/herramientas/classroom.png)
