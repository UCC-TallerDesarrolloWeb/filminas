...
El proyecto debe ser creado por un solo integrante del grupo.
Una vez creado, debes ir a **Settings**, y en la sección de **Collaborators and teams**, en **Add people**,
agregar a tu compañero de equipo por su usuario de github.
...
- [ ] Actualizar tecnologías usadas (2026)

---

### Requisitos del Segundo Parcial
#### Sobre Package
- Incluir los scripts necesarios para ejecución del proyecto y mock de servicios (2026)
- Las dependencias NO deben tener vulnerabilidades (2026) 
...
| Consistencia del diseño y uso de estilos |
